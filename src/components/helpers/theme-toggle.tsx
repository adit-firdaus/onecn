...
export function ThemeToggle({ className }: ThemeToggleProps) {
  const { defaultProps, baseClassName } = useComponentConfig<ThemeToggleProps>("ThemeToggle");
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="outline" size="icon" className={mergedClassName} {...restDefaults}>
